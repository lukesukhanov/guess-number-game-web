...
class AuthorizationService {
  ...
  static async loginWithPassword(username, password) {
    const response = await AuthorizationService.requestLoginWithPassword(
      username,
      password
    );
    await AuthorizationService.handleLoginResponse(response);
  ...
  static async register(username, password) {
    const response = await AuthorizationService.requestRegister(
      username,
      password
    );
    await AuthorizationService.handleRegisterResponse(
      response,
      username,
      password
    );
